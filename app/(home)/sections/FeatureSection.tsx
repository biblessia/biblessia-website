  ...
  return (
    <div className="gap-[48]">
      <div className="flex flex-col gap-[12] md:gap-[24]">
        <Diamond className="w-[44] h-[44] md:w-[56] md:h-[56] lg:w-[64] lg:h-[64]" />
...
function FeatureItemList() {
  const features: Feature[] = [
    {
      emoji: (
        <EmojiQT className="w-[36] h-[36] md:w-[52] md:h-[52] lg:w-[64] lg:h-[64]" />
      ),
      title: "말씀 묵상",
      description:
    ...
    {
      emoji: (
        <EmojiReading className="w-[36] h-[36] md:w-[52] md:h-[52] lg:w-[64] lg:h-[64]" />
      ),
      title: "성경 읽기",
      description:
    ...
    {
      emoji: (
        <EmojiPrayer className="w-[36] h-[36] md:w-[52] md:h-[52] lg:w-[64] lg:h-[64]" />
      ),
      title: "중보 기도",
      description:
    ...
    {
      emoji: (
        <EmojiJournal className="w-[36] h-[36] md:w-[52] md:h-[52] lg:w-[64] lg:h-[64]" />
      ),
      title: "감사 일기",
      description:
    ...
    {
      emoji: (
        <EmojiBook className="w-[36] h-[36] md:w-[52] md:h-[52] lg:w-[64] lg:h-[64]" />
      ),
      title: "신앙 서적",
      description:
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-[20] gap-[12]">
